...
const Button2WithRadium = Radium(Button2);

it('should render Button with default style', () => {
  expect(render(<ButtonWithRadium />)).toMatchSnapshot();
});

it('should render Button with default style overriden with custom style (as object)', () => {
  expect(
    render(<ButtonWithRadium style={{ button: { paddingLeft: '100px' } }} />),
  ).toMatchSnapshot();
});
...
it('should render Button with default style merged with custom style (as object)', () => {
  expect(
    render(
      <ButtonWithRadium style={{ text: { textTransform: 'uppercase' } }} />,
    ),
  ).toMatchSnapshot();
});
...
it('should render Button with passed styles and different styles', () => {
  expect(
    render(
      <div>
        <ButtonWithRadium style={{ button: { paddingLeft: '5px' } }} />
        <ButtonWithRadium style={{ button: { paddingLeft: '10px' } }} />
      </div>,
    ),
  ).toMatchSnapshot();
});
...
it('should render Button2 with passed styles and different styles', () => {
  expect(
    render(
      <div>
        <Button2WithRadium style={{ button: { paddingLeft: '5px' } }} />
        <Button2WithRadium style={{ button: { paddingLeft: '10px' } }} />
      </div>,
    ),
  ).toMatchSnapshot();
});
